...
# Parameters
parser = argparse.ArgumentParser(description='Cylinder flow SR demo')
parser.add_argument('--continue_training', type=bool, default=False, help='continue training or not')

parser.add_argument('--data', type=str, default='cylinder2d', help='GMM, Gaussian, cifar10, ns1, ns2, ns3, ns4')
parser.add_argument('--data_location', type=str,
                    default="/media/group3/lzy/Data/PIV/cylinder2d_piv.npy",
...
parser.add_argument('--version', type=str, default='v1_rp', help='model version')
parser.add_argument('--is_train', type=bool, default=True, help='training or evaluating')
parser.add_argument('--train_portion', type=float, default=0.7, help='portion of data for training')
...
parser.add_argument('--small_batch_size', type=int, default=2, help='small batch size for inner loops')
...
# image
parser.add_argument('--image_size', type=int, default=48, help='32 for cifar10, 64 for ns1, 512 for ns2')
parser.add_argument('--crop_size', type=int, default=32, help='32 for cifar10, 64 for ns1, 512 for ns2')
...
parser.add_argument('--masks', type=float, nargs='+', default=[0.98, 0.995, 10000], help='range of masked ratio for random_points')

# model
parser.add_argument('--model_name', type=str, default='diffusion', help='diffusion, fno2d')
