...
parser.add_argument('--data_location', type=str,
                    default="/media/group3/lzy/Data/cylinder2d/cylinder2d_piv_crop.npy",
...
parser.add_argument('--image_size_h', type=int, default=48, help='32 for cifar10, 64 for ns1, 512 for ns2')
parser.add_argument('--image_size_w', type=int, default=64, help='32 for cifar10, 64 for ns1, 512 for ns2')
parser.add_argument('--crop_size', type=int, default=48, help='32 for cifar10, 64 for ns1, 512 for ns2')
